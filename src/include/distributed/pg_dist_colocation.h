 ...
 * ----------------
 */
#define Natts_pg_dist_colocation 7
...
#define Anum_pg_dist_colocation_associatedschema 6
#define Anum_pg_dist_colocation_associatedgroupid 7
